...
from YoneRobot import dispatcher, DRAGONS, DEMONS, LOGGER
...
def goodnight(update, context):
    ...
    update.effective_message.reply_text(random.choice(fun.GDNIGHT))
...
def goodmorning(update, context):
    ...
    message.reply_text(reply, parse_mode=ParseMode.MARKDOWN) 
    update.effective_message.reply_text(random.choice(fun.GDMORNING))
...
def goodevening(update, context):
    message = update.effective_message
    first_name = update.effective_user.first_name
    reply = f"Good Evening! {escape_markdown(first_name)}"
    message.reply_text(reply, parse_mode=ParseMode.MARKDOWN) 
    update.effective_message.reply_text(random.choice(fun.GDEVENING))
...
GDMORNING_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(goodmorning|morg|good morning)"), goodmorning, friendly="goodmorning"
)
GDNIGHT_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(goodnight|good night)"), goodnight, friendly="goodnight"
)
GDEVENING_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(goodevening|good evening)"), goodevening, friendly="goodevening"
)
...
dispatcher.add_handler(GDEVENING_HANDLER)
